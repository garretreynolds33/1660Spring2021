...
//Name: Starship.ma
//Last modified: Thu, Jan 28, 2021 08:59:48 PM
//Codeset: 1252
requires maya "2020";
...
fileInfo "UUID" "3A473B56-4E86-416E-2797-ACAED0F3CAA6";
createNode transform -s -n "persp";
	rename -uid "2C8CD541-40C4-49A1-4580-3688F23FC09E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -42.30528725374343 8.69021033899838 -0.80126578282765593 ;
	setAttr ".r" -type "double3" -1.5383527297696753 -804.99999999996885 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "10A55D4D-4DF5-166F-9BC5-6796F5CDCD29";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 39.618192109156006;
...
createNode transform -n "pCylinder3";
	...
	setAttr ".t" -type "double3" 0 3.0206722299393896 -2.820944591577073 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "8D86EAD8-4B8D-BD30-914B-C18266FC2A0B";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "23C29318-4A7D-1B33-DE12-FAB3E07DFBD5";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "EE397FFF-4ADA-870C-3368-AF97AE852313";
createNode displayLayerManager -n "layerManager";
	rename -uid "FF52E4B1-457F-6F43-9E6E-529A13F28B3B";
createNode displayLayer -n "defaultLayer";
	rename -uid "3A03600F-4A9B-F057-6F29-469821CCDADE";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "2FFA2CC2-41D6-61C1-4864-DBAC234A4E6F";
